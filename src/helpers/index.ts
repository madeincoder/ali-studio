...
export const appName: string = "all these pages with made by";
export const appTitle: string =
  "WebAI Vue - AI Startup & Technology Landing Page HTML Template";
...
export const appAuthor: string = "ali-studio";
