      ...
      <div class="grid lg:grid-cols-2 gap-10">
        <div class="hidden lg:block ps-4 py-4">
          <div class="relative rounded-xl overflow-hidden h-full w-full">
            <img
              :src="authImg"
              alt=""
              class="w-full h-full max-h-[700px] transform -scale-x-100"
            />
            <!-- <div class="absolute inset-0 bg-default-950/40">
              <div class="flex items-end justify-center h-full">
                <div class="p-6 text-start">
                  ...
                  <p class="text-base font-medium text-default-500">Try all paid functions for free. just register and
        ...
        <div class="flex flex-col h-full p-10 lg:ps-0">
          ...
          <div class="pb6 my-auto">
            <h4 class="text-2xl font-bold text-white mb-4">New to Ali</h4>
...
import authImg from "@/assets/images/ali/photo-1.jpg";
</script>
