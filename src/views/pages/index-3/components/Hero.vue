          ...
          <div class="py-14 text-center relative">
            <div class="flex justify-center">
              <div class="max-w-2xl">
                ...
                >
                  Make Trailer From long ones instantly
                </h2>
                <p class="text-base text-default-200 font-medium px-5">
                  <b>Create</b> a captivating <b>trailer</b> in just a few
                  seconds by dropping your video here thanks to our fully
                  automatic <b>AI tools</b>, editing, sound, music etc
                </p>
                <div
