            ...
            >
              <div class="md:me-6">
                ...
                >
                  ...
                  <!-- <span class="bg-primary text-transparent bg-clip-text"
                    >Discover Library</span
                  > -->
                  Downloads thousands of characters and sets ideas
                </h4>
                <p class="text-lg max-w-xl text-default-200 mb-6">
                  Our image library generated by our best artists available to
                  inspire you or save time instantly
                </p>
                ...
                <div>
                  ...
                  <a
                    ...
                    >Sell yours
                    <i
                      class="mdi mdi-arrow-top-right-thin text-xl leading-[0]"
                    ></i
                  ></a>
                </div>
              </div>
...
import nftArt5 from "@/assets/images/ali/library/3.jpg";
import nftArt6 from "@/assets/images/ali/library/4.jpg";
import nftArt18 from "@/assets/images/ali/library/2.jpg";
import nftArt22 from "@/assets/images/ali/library/1.jpg";
</script>
