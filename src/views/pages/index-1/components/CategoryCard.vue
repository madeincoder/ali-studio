<template>
  ...
  >
    <div class="p-3">
      <div class="relative">
        <a href="https://www.ali-marketplace.com">
          <img
            :src="item.image"
            alt=""
            class="rounded-md h-full w-full aspect-[1/1] object-cover"
          />
        </a>
        <div
        ...
        >
          <div class="inline-flex justify-center w-full">
            <div
              class="bg-gradient-to-r from-rose-500 to-blue-600 py-1 px-2.5 rounded-full"
            >
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <span class="block font-semibold text-primary"
              ><i
                class="mdi mdi-ethereum text-xl leading-none text-primary me-1"
              ></i
              >{{ item.bid.current }} ETH</span
            >
          </div>
          <div class="text-end">
