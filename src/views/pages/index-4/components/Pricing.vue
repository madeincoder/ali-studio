      ...
      <div class="flex items-end justify-between mb-10">
        <div class="max-w-2xl mx-auto text-center">
          <h2 class="text-3xl font-medium capitalize text-white mb-4">
            Pricing and plans Additionnal Credits everyone
          </h2>
          <p class="text-sm text-default-200 font-medium">
            To take it even further and unlock your full potential, you can
            purchase <br />additional credits to enhance the quality of your
            films.
          </p>
        </div>
      </div>
